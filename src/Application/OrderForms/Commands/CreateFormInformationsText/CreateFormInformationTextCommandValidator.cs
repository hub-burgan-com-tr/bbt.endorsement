...
{
    public class CreateFormInformationTextCommandValidator : AbstractValidator<CreateFormInformationTextCommand>
    {
 
        public CreateFormInformationTextCommandValidator()
        {
