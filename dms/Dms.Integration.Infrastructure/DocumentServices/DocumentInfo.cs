...
{
    public BhsDocument(DocumentBase document, DmsPerson owner, string channelReferenceId, long customerNo, string citizenshipNumber, string branchCode, string bhsOrderNo, string version)
