...
{
    public BhsDocument(DocumentBase document, PersonModel owner, string channelReferenceId, long customerNo, string citizenshipNumber, string branchCode, string bhsOrderNo, string version)
